...
<div class="article toolbar">
    ...
    <div class="content">
        <ul class="toollist ue-clear">
            <li>
                <a href="work.html" class="img" target="right"><img src="<?=site_url('weblib/')?>images/icon01.png" /></a>
                <p><a href="work.html" target="right">工作日志</a></p>
            </li>
            <li>
                <a href="email.html" class="img" target="right"><img src="<?=site_url('weblib/')?>images/email03.png" /></a>
                <p><a href="email.html" target="right">邮箱</a></p>
            </li>
            <li>
                <a href="mailList.html" class="img" target="right"><img src="<?=site_url('weblib/')?>images/icon02.png" /></a>
                <p><a href="mailList.html" target="right">通讯录</a></p>
            </li>
            <li>
                <a href="schedule.html" class="img" target="right"><img src="<?=site_url('weblib/')?>images/icon04.png" /></a>
                <p><a href="schedule.html" target="right">日程安排</a></p>
            </li>
            <li>
                <a href="javascript:;" class="img" target="right"><img src="<?=site_url('weblib/')?>images/datecion01.png"/></a>
                <p><a href="javascript:;" onclick="openlayer()">万年历</a></p>
            </li>
            <li>
                <a href="leave.html" class="img"><img src="<?=site_url('weblib/')?>images/leave01.png" /></a>
                <p><a href="leave.html">请假申请</a></p>
            </li>
            <li>
                <a href="fcontract_sign.html" class="img" target="right"><img src="<?=site_url('weblib/')?>images/posintion01.png" /></a>
                <p><a href="fcontract_sign.html" target="right">项目合同会签</a></p>
            </li>
            <li>
                <a href="file_sign.html" class="img" target="right"><img src="<?=site_url('weblib/')?>images/file02.png" /></a>
                <p><a href="file_sign.html" target="right">文件会签</a></p>
            </li>
            <li>
                <a href="document_wait.html" class="img" target="right"><img src="<?=site_url('weblib/')?>images/file03.png" /></a>
                <p><a href="document_wait.html" target="right">公文办理</a></p>
            </li>
            <li>
                <a href="recode.html" class="img" target="right"><img src="<?=site_url('weblib/')?>images/icon07.png" /></a>
                <p><a href="recode.html" target="right">定制任务</a></p>
            </li>
            <li>
                <a href="dossier_my.html" class="img" target="right"><img src="<?=site_url('weblib/')?>images/myFiles.png" /></a>
                <p><a href="dossier_my.html" target="right">个人档案</a></p>
            </li>
            <li class="add-btn">
                <img src="<?=site_url('weblib/')?>images/add.png" />
            </li>
        </ul>
...
<script src="<?=site_url('weblib/')?>js/bootstrap.min.js"></script>
<script src="<?=site_url('weblib/')?>js/bootstrap-table.js"></script>
<script src="<?=site_url('weblib/')?>js/bootstrap-table-zh-CN.min.js"></script>
<script>
    $(function () {
...
<script type="text/javascript" src="<?=site_url('weblib/')?>js/common.js"></script>
...
<script src="<?=site_url('weblib/')?>js/layer_v2.1/layer/layer.js"></script>
<script type="text/javascript">
